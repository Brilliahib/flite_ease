...
@section('container')
    <div class="home" style="min-height: 92.5vh;">
        <div class="container">
                            ...
                            <div class="cari-tiket">
                                <div class="card-form my-3">
                                    ...
                                    <select name="bandara_asal" class="border-0 main-form" style="cursor: pointer;">
                                        @foreach ($tikets as $tiket)
                                            <option value="{{ $tiket->bandaraAsal->id }}">
                                                {{ $tiket->bandaraAsal->nama_bandara }}</option>
                                        @endforeach
                                ...
                                <div class="card-form my-3">
                                    ...
                                    <select name="bandara_tujuan" class="border-0 main-form" style="cursor: pointer;">
                                        @foreach ($tikets as $tiket)
                                            <option value="{{ $tiket->bandaraTujuan->id }}">
                                                {{ $tiket->bandaraTujuan->nama_bandara }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <button type="submit" class="btn" style="width: 100%; margin-top:12px">Cari
                                    Tiket</button>
                            </div>
                    </div>
                    </form>
